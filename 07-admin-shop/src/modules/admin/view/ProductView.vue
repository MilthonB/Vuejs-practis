  ...
  <form @submit="onSubmit" class="grid grid-cols-1 sm:grid-cols-2 bg-white px-5 gap-5">
    <div class="first-col">
      ...
      <div class="mb-4">
        ...
        <CustomInput v-model="title" v-bind="titlelAttrs" :error="errors.title"></CustomInput>
        <!-- <input 
        v-model="title"
        v-bind="titlelAttrs"
        type="text" 
      ...
      <div class="mb-4">
        ...
        <CustomInput v-model="slug" v-bind="sluglAttrs" :error="errors.slug"></CustomInput>
      </div>
      ...
      <div class="flex flex-row gap-3">
        ...
        <!-- <div class="mb-4">
          ...
          <CustomInput v-model="stock" v-bind="stocklAttrs" :error="errors.stock"></CustomInput>
        </div> -->
      </div>
    ...
    <div class="first-col">
      ...
      <div class="col-span-2 my-2">
        ...
        type="file" id="image" class="form-control" accept="image/*" />
      </div>

      <div class="mb-4">
        <label for="stock" class="form-label">Género</label>
        <select v-model="gender" v-bind="genderlAttrs" class="form-control">
